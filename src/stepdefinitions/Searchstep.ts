...
Given('the user enters the valid {string}', async function (this:CustomWorld,keyword:string) {
...
Then('the success {string} is displayed intimating product is added to cart', async function (this:CustomWorld,message) {
